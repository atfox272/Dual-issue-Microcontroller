...
#
# Generated by Vivado on Wed Dec 13 01:30:30 +0700 2023
...
xv_boost_lib_path=L:/Application/Xilinx/Vivado/2020.2/tps/boost_1_64_0
xvlog_opts="--relax"
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:Dual_core_mcu_tb:Functional:clk_wiz_0} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="L:/Application/Xilinx/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
